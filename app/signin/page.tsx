    ...
    <div className="flex items-center justify-center h-screen">
      <div className="max-w-md w-full p-6 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-6 text-center">
          Sign In to Metaverse Classroom
        </h1>
        ...
        {state.status === "success" && (
          <div className="text-green-600 mt-4 text-center">
            Login link sent! Please check your email and click the link to sign
            in.
          </div>
        )}
        <p className="text-sm text-gray-500 mt-6 text-center">
          You&apos;ll receive an email with a secure link to access the
          Metaverse Classroom. The link is valid for 1 hour and can be used only
          once.
        </p>
      </div>
    </div>
